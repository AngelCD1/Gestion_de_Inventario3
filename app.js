    ...
    const processSale = useCallback(async () => {
        ...
        try {
            ...
            const invoice = {
                ...
                date: new Date().toISOString(),
                userId: user ? user.uid : 'caja-mode',
                invoiceNumber: `FAC-${Date.now().toString().slice(-6)}` // Número legible
            };
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        {sales.slice().reverse().map(sale => (
                                            <div key={sale.id} className={`border-l-4 border-green-500 ${darkMode ? 'bg-green-900/20' : 'bg-green-50'} p-4 rounded-xl hover-lift`}>
                                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                                    <div className="flex-1">
